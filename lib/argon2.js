(function (root, factory) {
    ...
    function initFallbackJsModule() {
        return new Promise((resolve) => {
            ...
            return loadFallbackJsModule();
        });
    }

    function loadFallbackJsModule() {
        if (global.loadArgon2FallbackJsModule) {
            return global.loadArgon2FallbackJsModule();
        }
        if (typeof require === 'function') {
            return Promise.resolve(require('../dist/argon2-fallback.js'));
        }
        return import('../dist/argon2-fallback.js');
    }
